// $ANTLR 3.4.1-SNAPSHOT MapCSSLexer.g 2012-11-24 10:37:59
...
class MapCSSLexer extends Lexer {
  ...
  void mRGBA() {
    try {
  	  ...
  	  int _channel = BaseRecognizer.DEFAULT_TOKEN_CHANNEL;
  	  /* grammar/MapCSS.g:
  	   107:5: ( ( 'r' | 'R' ) ( 'g' | 'G' ) ( 'b' | 'B' ) ( 'a' | 'A' ) )*/
  	  /* grammar/MapCSS.g:
  	   107:7: ( 'r' | 'R' ) ( 'g' | 'G' ) ( 'b' | 'B' ) ( 'a' | 'A' )*/
  	  {
  	  	if(input.LA(1) == 82 /*'R'*/
  	  	  || input.LA(1) == 114 /*'r'*/) {
  	  	  input.consume();
  ...
  void mROLE() {
    try {
  	  ...
  	  int _channel = BaseRecognizer.DEFAULT_TOKEN_CHANNEL;
  	  /* grammar/MapCSS.g:
  	   109:5: ( ( 'r' | 'R' ) ( 'o' | 'O' ) ( 'l' | 'L' ) ( 'e' | 'E' ) )*/
  	  /* grammar/MapCSS.g:
  	   109:7: ( 'r' | 'R' ) ( 'o' | 'O' ) ( 'l' | 'L' ) ( 'e' | 'E' )*/
  	  {
  	  	if(input.LA(1) == 82 /*'R'*/
  	  	  || input.LA(1) == 114 /*'r'*/) {
  	  	  input.consume();
  ...
  void mINDEX() {
    try {
  	  ...
  	  int _channel = BaseRecognizer.DEFAULT_TOKEN_CHANNEL;
  	  /* grammar/MapCSS.g:
  	   110:6: ( ( 'i' | 'I' ) ( 'n' | 'N' ) ( 'd' | 'D' ) ( 'e' | 'E' ) ( 'x' | 'X' ) )*/
  	  /* grammar/MapCSS.g:
  	   110:8: ( 'i' | 'I' ) ( 'n' | 'N' ) ( 'd' | 'D' ) ( 'e' | 'E' ) ( 'x' | 'X' )*/
  	  {
  	  	if(input.LA(1) == 73 /*'I'*/
  	  	  || input.LA(1) == 105 /*'i'*/) {
  	  	  input.consume();
  ...
  void mIDENT() {
    try {
  	  ...
  	  int _channel = BaseRecognizer.DEFAULT_TOKEN_CHANNEL;
  	  /* grammar/MapCSS.g:
  	   112:6: ( SIDCHAR ( IDCHAR )* )*/
  	  /* grammar/MapCSS.g:
  	   112:8: SIDCHAR ( IDCHAR )**/
  	  {
  	  	mSIDCHAR(); 
  	  	if(state.failed) 
  	  	  return ;
  ...
  void mHEXCOLOR() {
    try {
  	  ...
  	  int _channel = BaseRecognizer.DEFAULT_TOKEN_CHANNEL;
  	  /* grammar/MapCSS.g:
  	   117:9: ( '#' ( ( HEXDIGIT HEXDIGIT HEXDIGIT HEXDIGIT HEXDIGIT HEXDIGIT ) | 
  	   ( HEXDIGIT HEXDIGIT HEXDIGIT ) ) )*/
  	  /* grammar/MapCSS.g:
  	   117:11: '#' ( ( HEXDIGIT HEXDIGIT HEXDIGIT HEXDIGIT HEXDIGIT HEXDIGIT ) | 
  	   ( HEXDIGIT HEXDIGIT HEXDIGIT ) )*/
  	  {
  	  	match(35 /*'#'*/); 
  	  	if(state.failed) 
  	  	...
  	  	/* grammar/MapCSS.g:
  	  	 117:15: ( ( HEXDIGIT HEXDIGIT HEXDIGIT HEXDIGIT HEXDIGIT HEXDIGIT ) | 
  	  	 ( HEXDIGIT HEXDIGIT HEXDIGIT ) )*/
  	  	int alt4 = 2;
  	  	...
  	  	switch (alt4) {
  	  	  case 1 :
  	  	    /* grammar/MapCSS.g:
  	  	     117:16: ( HEXDIGIT HEXDIGIT HEXDIGIT HEXDIGIT HEXDIGIT HEXDIGIT )*/
  	  	    {
  	  	    	/* grammar/MapCSS.g:
  	  	    	 117:16: ( HEXDIGIT HEXDIGIT HEXDIGIT HEXDIGIT HEXDIGIT HEXDIGIT )*/
  	  	    	/* grammar/MapCSS.g:
  	  	    	 117:17: HEXDIGIT HEXDIGIT HEXDIGIT HEXDIGIT HEXDIGIT HEXDIGIT*/
  	  	    	{
  	  	    		mHEXDIGIT(); 
  	  	    		if(state.failed) 
  	  	    		  return ;
  	  	  ...
  	  	  case 2 :
  	  	    /* grammar/MapCSS.g:
  	  	     117:74: ( HEXDIGIT HEXDIGIT HEXDIGIT )*/
  	  	    {
  	  	    	/* grammar/MapCSS.g:
  	  	    	 117:74: ( HEXDIGIT HEXDIGIT HEXDIGIT )*/
  	  	    	/* grammar/MapCSS.g:
  	  	    	 117:75: HEXDIGIT HEXDIGIT HEXDIGIT*/
  	  	    	{
  	  	    		mHEXDIGIT(); 
  	  	    		if(state.failed) 
  	  	    		  return ;
  ...
  void mREGEXP() {
    try {
  	  ...
  	  int _channel = BaseRecognizer.DEFAULT_TOKEN_CHANNEL;
  	  /* grammar/MapCSS.g:
  	   140:7: ( '/' ( REGEX_CHAR | REGEX_ESCAPE )* '/' )*/
  	  /* grammar/MapCSS.g:
  	   140:10: '/' ( REGEX_CHAR | REGEX_ESCAPE )* '/'*/
  	  {
  	  	match(47 /*'/'*/); 
  	  	if(state.failed) 
  	  	  return ;
  	  	...
  	  	/* grammar/MapCSS.g:
  	  	 140:14: ( REGEX_CHAR | REGEX_ESCAPE )**/
  	  	loop6:
  	  	do {
  	  	  int alt6 = 3;
  ...
  void mSL_COMMENT() {
    try {
  	  ...
  	  int _channel = BaseRecognizer.DEFAULT_TOKEN_CHANNEL;
  	  /* grammar/MapCSS.g:
  	   144:11: ( '//' ( options {greedy=false; } : . )* ( '\\r' )? '\\n' )*/
  	  /* grammar/MapCSS.g:
  	   144:15: '//' ( options {greedy=false; } : . )* ( '\\r' )? '\\n'*/
  	  {
  	  	match("//"); 
  	  	if(state.failed) 
  	  	  return ;
  ...
  void mML_COMMENT() {
    try {
  	  ...
  	  int _channel = BaseRecognizer.DEFAULT_TOKEN_CHANNEL;
  	  /* grammar/MapCSS.g:
  	   145:11: ( '/*' ( options {greedy=false; } : . )* '*/' )*/
  	  /* grammar/MapCSS.g:
  	   145:15: '/*' ( options {greedy=false; } : . )* '*/'*/
  	  {
  	  	match("/*"); 
  	  	if(state.failed) 
  	  	  return ;
  ...
  void mRANGE() {
    try {
  	  ...
  	  int _channel = BaseRecognizer.DEFAULT_TOKEN_CHANNEL;
  	  /* grammar/MapCSS.g:
  	   205:2: ( '|z' ( '-' ( DIGIT )+ | ( DIGIT )+ | ( DIGIT )+ '-' | 
  	   ( DIGIT )+ '-' ( DIGIT )+ ) )*/
  	  /* grammar/MapCSS.g:
  	   205:4: '|z' ( '-' ( DIGIT )+ | ( DIGIT )+ | ( DIGIT )+ '-' | 
  	   ( DIGIT )+ '-' ( DIGIT )+ )*/
  	  {
  	  	match("|z"); 
  	  	if(state.failed) 
  	  	...
  	  	/* grammar/MapCSS.g:
  	  	 205:9: ( '-' ( DIGIT )+ | ( DIGIT )+ | ( DIGIT )+ '-' | ( DIGIT )+ '-' ( DIGIT )+ ) */
  	  	int alt15 = 4;
  ...
  void mNUMBER() {
    try {
  	  ...
  	  int _channel = BaseRecognizer.DEFAULT_TOKEN_CHANNEL;
  	  /* grammar/MapCSS.g:
  	   313:2: ( ( DIGIT )+ ( ( P ( T | X ) )=> P ( T | X ) | ( '%' )=> '%' | 
  	   ( '.' )=> '.' ( DIGIT )+ ( ( P ( T | X ) )=> P ( T | X ) | ( '%' )=> '%' |) |) ) */
  	  /* grammar/MapCSS.g:
  	   313:4: ( DIGIT )+ ( ( P ( T | X ) )=> P ( T | X ) | ( '%' )=> '%' | 
  	   ( '.' )=> '.' ( DIGIT )+ ( ( P ( T | X ) )=> P ( T | X ) | ( '%' )=> '%' |) |) */
  	  {
  	  	/* grammar/MapCSS.g:
  	  	 313:4: ( DIGIT )+*/
  ...
  void mTokens() {
    /* grammar/MapCSS.g: 
     1:8: ( T__94 | T__95 | T__96 | T__97 | T__98 | T__99 | T__100 | 
...
class DFA_MapCSSLexer_22 extends DFA {
  ...
  String get description => 
        """1:1: Tokens : ( T__94 | T__95 | T__96 | T__97 | T__98 | T__99 | 
T__100 | T__101 | T__102 | T__103 | T__104 | T__105 | T__106 | 
T__107 | T__108 | T__109 | T__110 | T__111 | T__112 | T__113 | 
T__114 | URL | RGBA | RGB | ROLE | INDEX | IDENT | DQUOTED_STRING | 
...
WS | SL_COMMENT | ML_COMMENT | RANGE | NUMBER );""";
  ...
  int specialStateTransition(int s, IntStream _input){
    ...
    int _s = s;
    switch(s) {
      case 0 :int LA22_94 = recognizer.input.LA(1);
      ...
      if(s>=0) return s;
      break;
      case 1 :int LA22_96 = recognizer.input.LA(1);
      ...
      if(s>=0) return s;
      break;
      case 2 :int LA22_95 = recognizer.input.LA(1);
      ...
      if(s>=0) return s;
      break;
      case 4 :int LA22_78 = recognizer.input.LA(1);
      ...
      else if(LA22_78 == 40/*40 /*'('*/*/) {
        s = 94;
      }

      else if(LA22_78 == 41/*41 /*')'*/*/) {
        s = 95;
      }

      else if(LA22_78 == 124/*124 /*'|'*/*/) {
        s = 96;
      }

      else if(LA22_78 == 36/*36 /*'$'*/*/) {
        s = 97;
      }

      else if(LA22_78 == 42/*42 /*'*'*/*/) {
        s = 98;
      }

      else if(LA22_78 == 46/*46 /*'.'*/*/) {
        s = 99;
      }

      else if(LA22_78 == 94/*94 /*'^'*/*/) {
        s = 100;
      }

      else if(LA22_78 == 63/*63 /*'?'*/*/) {
        s = 101;
      }

      else if(LA22_78 == 43/*43 /*'+'*/*/) {
        s = 102;
      }

      else if(LA22_78 == 45/*45 /*'-'*/*/) {
        s = 103;
      }

      else if(LA22_78 == 110/*110 /*'n'*/*/) {
        s = 104;
      }

      else if(LA22_78 == 114/*114 /*'r'*/*/) {
        s = 105;
      }

      else if(LA22_78 == 116/*116 /*'t'*/*/) {
        s = 106;
      }

      else if(LA22_78 == 115/*115 /*'s'*/*/) {
        s = 107;
      }

      else if(LA22_78 == 83/*83 /*'S'*/*/) {
        s = 108;
      }

      else if(LA22_78 == 100/*100 /*'d'*/*/) {
        s = 109;
      }

      else if(LA22_78 == 68/*68 /*'D'*/*/) {
        s = 110;
      }

      else if(LA22_78 == 119/*119 /*'w'*/*/) {
        s = 111;
      }

      else if(LA22_78 == 87/*87 /*'W'*/*/) {
        s = 112;
      }

      else if((LA22_78 >= 0 /*'\u0000'*/ && LA22_78 <= 35 /*'#'*/)
        || (LA22_78 >= 37 /*'%'*/ && LA22_78 <= 39 /*'\''*/)
        || LA22_78 == 44/*44 /*','*/*/
        || (LA22_78 >= 48 /*'0'*/ && LA22_78 <= 62 /*'>'*/)
        || (LA22_78 >= 64 /*'@'*/ && LA22_78 <= 67 /*'C'*/)
        || (LA22_78 >= 69 /*'E'*/ && LA22_78 <= 82 /*'R'*/)
        || (LA22_78 >= 84 /*'T'*/ && LA22_78 <= 86 /*'V'*/)
        || (LA22_78 >= 88 /*'X'*/ && LA22_78 <= 91 /*'['*/)
        || LA22_78 == 93/*93 /*']'*/*/
        || (LA22_78 >= 95 /*'_'*/ && LA22_78 <= 99 /*'c'*/)
        || (LA22_78 >= 101 /*'e'*/ && LA22_78 <= 109 /*'m'*/)
        || (LA22_78 >= 111 /*'o'*/ && LA22_78 <= 113 /*'q'*/)
        || (LA22_78 >= 117 /*'u'*/ && LA22_78 <= 118 /*'v'*/)
        || (LA22_78 >= 120 /*'x'*/ && LA22_78 <= 123 /*'{'*/)
        || (LA22_78 >= 125 /*'}'*/ && LA22_78 <= 65535 /*'\uFFFF'*/)) {
        s = 79;
      }

      if(s>=0) return s;
      break;
      case 5 :int LA22_93 = recognizer.input.LA(1);
      ...
      if(s>=0) return s;
      break;
      case 6 :int LA22_101 = recognizer.input.LA(1);
      ...
      if(s>=0) return s;
      break;
      case 7 :int LA22_99 = recognizer.input.LA(1);
      ...
      if(s>=0) return s;
      break;
      case 8 :int LA22_100 = recognizer.input.LA(1);
      ...
      if(s>=0) return s;
      break;
      case 9 :int LA22_97 = recognizer.input.LA(1);
      ...
      if(s>=0) return s;
      break;
      case 11 :int LA22_105 = recognizer.input.LA(1);
      ...
      if(s>=0) return s;
      break;
      case 12 :int LA22_103 = recognizer.input.LA(1);
      ...
      if(s>=0) return s;
      break;
      case 13 :int LA22_104 = recognizer.input.LA(1);
      ...
      if(s>=0) return s;
      break;
      case 15 :int LA22_112 = recognizer.input.LA(1);
      ...
      if(s>=0) return s;
      break;
      case 16 :int LA22_111 = recognizer.input.LA(1);
      ...
      if(s>=0) return s;
      break;
      case 17 :int LA22_110 = recognizer.input.LA(1);
      ...
      if(s>=0) return s;
      break;
      case 18 :int LA22_109 = recognizer.input.LA(1);
      ...
      if(s>=0) return s;
      break;
      case 19 :int LA22_108 = recognizer.input.LA(1);
      ...
      if(s>=0) return s;
      break;
      case 20 :int LA22_107 = recognizer.input.LA(1);
      ...
      if(s>=0) return s;
      break;
      case 21 :int LA22_75 = recognizer.input.LA(1);
      ...
      else if(LA22_75 == 42/*42 /*'*'*/*/) {
        s = 75;
      }

      else if((LA22_75 >= 32 /*' '*/ && LA22_75 <= 41 /*')'*/)
        || (LA22_75 >= 43 /*'+'*/ && LA22_75 <= 46 /*'.'*/)
        || (LA22_75 >= 48 /*'0'*/ && LA22_75 <= 91 /*'['*/)
        || (LA22_75 >= 93 /*']'*/ && LA22_75 <= 126 /*'~'*/)
        || (LA22_75 >= 128 /*'\u0080'*/ && LA22_75 <= 65535 /*'\uFFFF'*/)) {
        s = 77;
      }

      else if(LA22_75 == 92/*92 /*'\\'*/*/) {
        s = 78;
      }

      else if((LA22_75 >= 0 /*'\u0000'*/ && LA22_75 <= 31 /*'\u001F'*/)
        || LA22_75 == 127/*127 /*'\u007F'*/*/) {
        s = 79;
      }
      ...
      if(s>=0) return s;
      break;
      case 22 :int LA22_91 = recognizer.input.LA(1);

      s = -1;
      if((LA22_91 >= 0 /*'\u0000'*/ && LA22_91 <= 65535 /*'\uFFFF'*/)) {
        s = 79;
      }
      ...
      if(s>=0) return s;
      break;
      case 23 :int LA22_61 = recognizer.input.LA(1);

      s = -1;
      if((LA22_61 >= 0 /*'\u0000'*/ && LA22_61 <= 65535 /*'\uFFFF'*/)) {
        s = 74;
      }
      ...
      if(s>=0) return s;
      break;
      case 24 :int LA22_62 = recognizer.input.LA(1);
      ...
      else if(LA22_62 == 47/*47 /*'/'*/*/) {
        s = 76;
      }

      else if((LA22_62 >= 32 /*' '*/ && LA22_62 <= 41 /*')'*/)
        || (LA22_62 >= 43 /*'+'*/ && LA22_62 <= 46 /*'.'*/)
        || (LA22_62 >= 48 /*'0'*/ && LA22_62 <= 91 /*'['*/)
        || (LA22_62 >= 93 /*']'*/ && LA22_62 <= 126 /*'~'*/)
        || (LA22_62 >= 128 /*'\u0080'*/ && LA22_62 <= 65535 /*'\uFFFF'*/)) {
        s = 77;
      }

      else if(LA22_62 == 92/*92 /*'\\'*/*/) {
        s = 78;
      }

      else if((LA22_62 >= 0 /*'\u0000'*/ && LA22_62 <= 31 /*'\u001F'*/)
        || LA22_62 == 127/*127 /*'\u007F'*/*/) {
        s = 79;
      }
      ...
      if(s>=0) return s;
      break;
      case 25 :int LA22_77 = recognizer.input.LA(1);
      ...
      else if((LA22_77 >= 32 /*' '*/ && LA22_77 <= 41 /*')'*/)
        || (LA22_77 >= 43 /*'+'*/ && LA22_77 <= 46 /*'.'*/)
        || (LA22_77 >= 48 /*'0'*/ && LA22_77 <= 91 /*'['*/)
        || (LA22_77 >= 93 /*']'*/ && LA22_77 <= 126 /*'~'*/)
        || (LA22_77 >= 128 /*'\u0080'*/ && LA22_77 <= 65535 /*'\uFFFF'*/)) {
        s = 77;
      }

      else if(LA22_77 == 92/*92 /*'\\'*/*/) {
        s = 78;
      }

      else if((LA22_77 >= 0 /*'\u0000'*/ && LA22_77 <= 31 /*'\u001F'*/)
        || LA22_77 == 127/*127 /*'\u007F'*/*/) {
        s = 79;
      }
      ...
      if(s>=0) return s;
      break;
      case 26 :int LA22_76 = recognizer.input.LA(1);

      s = -1;
      if((LA22_76 >= 0 /*'\u0000'*/ && LA22_76 <= 65535 /*'\uFFFF'*/)) {
        s = 79;
      }
      ...
      if(s>=0) return s;
      break;
      case 27 :int LA22_98 = recognizer.input.LA(1);
